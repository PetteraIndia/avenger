...
class LostAnimalsComments extends StatefulWidget {
  ...
  @override
  _LostAnimalsCommentsState createState() => _LostAnimalsCommentsState();
}

class _LostAnimalsCommentsState extends State<LostAnimalsComments> {
  late bool isLiked;
  late String userId;
  String userPhotoUrl = '';
        ...
        leading: IconButton(
          ...
          onPressed: () {
            Navigator.push(
              context,
              MaterialPageRoute(
                  builder: (context) => const SocialMediaPage(Si: 2, ci: 3)),
            );
          },
        ),
        elevation: 0,
