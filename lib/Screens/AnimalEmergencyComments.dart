...
class AnimalEmergencyComments extends StatefulWidget {
  ...
  @override
  _AnimalEmergencyCommentsState createState() =>
      _AnimalEmergencyCommentsState();
}

class _AnimalEmergencyCommentsState extends State<AnimalEmergencyComments> {
  late bool isLiked;
  late String userId;
  String userPhotoUrl = '';
        ...
        leading: IconButton(
          ...
          onPressed: () {
            Navigator.push(
              context,
              MaterialPageRoute(
                  builder: (context) => const SocialMediaPage(Si: 2, ci: 2)),
            );
          },
        ),
        elevation: 0,
