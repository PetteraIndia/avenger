  ...
  Widget build(BuildContext context) {
    ...
    //add more pages
                 ...
                 height: floatingBarHeight,
                  ...
                  child: Padding(
                      padding: EdgeInsets.all(screenSize.height * 0.016),
                         ...
                         children: [
                             ...
                             selectedIndex = 0;
                              ...
                              child: Column(
                               children: [
                                 Icon(Icons.home, color: selectedIndex == 0 ? Colors.black : Colors.white),
                               Text(
                                    'Social',
                                style: TextStyle(color: selectedIndex == 0 ? Colors.black : Colors.white),
                               ),
                              ],
                             ),
                             ),
                   ...
                   setState(() {
                      ...
                      child: Column(
                children: [
                      Icon(Icons.widgets, color: selectedIndex == 1 ? Colors.black : Colors.white),
                         Text(
                            'Services',
                         style: TextStyle(color: selectedIndex == 1 ? Colors.black : Colors.white),
                          ),
                         ],
                       ),
                  ),
                     ...
                     child: Column(
                       children: [
                           Icon(Icons.pets, color: selectedIndex == 2 ? Colors.black : Colors.white),
                         Text(
                          'Community',
                         style: TextStyle(color: selectedIndex == 2 ? Colors.black : Colors.white),
                              ),
                          ],
                      ),
                 ),
      GestureDetector(
            ...
            child: Column(
              children: [
                Icon(Icons.search, color: selectedIndex == 3 ? Colors.black : Colors.white),
                Text(
                  'Search',
                  style: TextStyle(color: selectedIndex == 3 ? Colors.black : Colors.white),
                ),
              ],
            ),
      ),
      GestureDetector(
            ...
            child: Column(
              children: [
                Icon(Icons.person, color: selectedIndex == 4 ? Colors.black : Colors.white),
                Text(
                  'Profile',
                  style: TextStyle(color: selectedIndex == 4 ? Colors.black : Colors.white),
                ),
              ],
            ),
      ),
