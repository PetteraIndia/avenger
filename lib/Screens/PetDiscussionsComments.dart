...
class PetDiscussionsComments extends StatefulWidget {
  ...
  @override
  _PetDiscussionsCommentsState createState() => _PetDiscussionsCommentsState();
}

class _PetDiscussionsCommentsState extends State<PetDiscussionsComments> {
  late bool isLiked;
  late String userId;
  String userPhotoUrl = '';
        ...
        leading: IconButton(
          ...
          onPressed: () {
            Navigator.push(
              context,
              MaterialPageRoute(
                  builder: (context) => const SocialMediaPage(Si: 2, ci: 6)),
            );
          },
        ),
        elevation: 0,
