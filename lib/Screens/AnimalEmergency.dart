...
class AnimalEmergency extends StatefulWidget {
  const AnimalEmergency({Key? key});

  @override
  State<AnimalEmergency> createState() => _AnimalEmergencyState();
}

class _AnimalEmergencyState extends State<AnimalEmergency> {
  late Stream<QuerySnapshot> _animalEmergencyStream;

  @override
  void initState() {
    super.initState();
    _animalEmergencyStream = FirebaseFirestore.instance
        .collection('animalemergency')
