...
class PetDiscussionsNewPost extends StatefulWidget {
  const PetDiscussionsNewPost({Key? key}) : super(key: key);

  @override
  State<PetDiscussionsNewPost> createState() => _PetDiscussionsNewPostState();
}

class _PetDiscussionsNewPostState extends State<PetDiscussionsNewPost> {
  ...
  Future<void> postIt(BuildContext context) async {
    if (captionController.text.isEmpty ||
      ...
      if (user != null) {
        ...
        final postsCollection = FirebaseFirestore.instance.collection('petdiscussions');
        ...
        for (int i = 0; i < selectedImages.length; i++) {
          ...
          final storagePath =
              'petdiscussions/$userId/${DateTime.now().millisecondsSinceEpoch}_$i.jpg';
