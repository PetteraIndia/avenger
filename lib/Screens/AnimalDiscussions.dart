...
class AnimalDiscussions extends StatefulWidget {
  const AnimalDiscussions({Key? key});

  @override
  State<AnimalDiscussions> createState() => _AnimalDiscussionsState();
}

class _AnimalDiscussionsState extends State<AnimalDiscussions> {
  late Stream<QuerySnapshot> _animalDiscussionsStream;

  @override
  void initState() {
    super.initState();
    _animalDiscussionsStream = FirebaseFirestore.instance
        .collection('animaldiscussions')
        ...
        children: [
          ...
          Expanded(
            child: StreamBuilder<QuerySnapshot>(
              stream: _animalDiscussionsStream,
