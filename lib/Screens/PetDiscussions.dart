...
import 'PetDiscussionsComments.dart';
import 'PetDiscussionsNewPost.dart';
...
class PetDiscussions extends StatefulWidget {
  const PetDiscussions({Key? key});

  @override
  State<PetDiscussions> createState() => _PetDiscussionsState();
}

class _PetDiscussionsState extends State<PetDiscussions> {
  late Stream<QuerySnapshot> _petDiscussionsStream;

  @override
  void initState() {
    super.initState();
    _petDiscussionsStream = FirebaseFirestore.instance
        .collection('petdiscussions')
                                ...
                                children: [
                                  ...
                                  GestureDetector(
                                    onTap: () {
                                      Navigator.push(
                                        context,
                                        MaterialPageRoute(builder: (context) => PetDiscussionsComments(likes: likes, username: username, description: description, uid: uid, datePublished: datePublished, isLiked: isLiked, photoUrl: photoUrl, document: document, caption: caption, formattedDate: formattedDate, location: location, postUrls: postUrls, timestamp: timestamp)),
                                      );
